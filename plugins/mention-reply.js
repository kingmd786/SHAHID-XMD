    ...
    if (m.mentionedJid.includes(botNumber)) {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "SHAHID-XMD 🥀",
            body: config.DESCRIPTION || "SHAHID-XMD🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/sxa61f.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/923423706291",
